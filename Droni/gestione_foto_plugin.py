...
class MenuSceltaDialog(QDialog):
    def __init__(self, plugin_dir):
        ...
        # Immagine Iniziale (logo_inizio.png)
...
class FinalMessageDialog(QDialog):
    def __init__(self, messaggio, plugin_dir):
        ...
        # Finestra finale con sfondo NERO e testo bianco
        self.setStyleSheet("background-color: #121212; color: #ffffff;")
        
        layout = QVBoxLayout()
        
        # Immagine Finale (logo_fine.png)
...
class GestioneFotoPlugin:
    ...
    def esegui_opzione_1(self):
        ...
        # Apri dialog di progresso con logo iniziale
...
# Entrypoint per il caricamento autonomo dal loader di QGIS
def run():
