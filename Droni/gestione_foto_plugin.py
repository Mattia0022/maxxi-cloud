...
from PyQt5.QtWidgets import (
    ...
    QFileDialog, QMessageBox, QInputDialog, QListWidget, QAbstractItemView, 
    QHBoxLayout, QProgressBar, QApplication, QGroupBox, QLineEdit
)
...
class EsportazioneLayoutDialog(QDialog):
    ...
    def avvia_esportazione(self):
        ...
        QMessageBox.information(self, "Fatto!", f"Esportazione completata con successo!\nGenerati {immagini_generate} file PNG.")
        self.accept()
...
class MenuSceltaDialog(QDialog):
    def __init__(self, plugin_dir):
        super().__init__()
        self.setWindowTitle("Gestione Foto, Droni & QGIS")
        self.resize(450, 400)
        ...
        self.combo.addItem("3. Cartella Droni: Esportazione Avanzata Layout / Atlanti in PNG")
