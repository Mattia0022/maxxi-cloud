...
if not point_layers:
    ...
    selected_layer_name, ok = QInputDialog.getItem(
        ...
        None, "Seleziona Layer", "Scegli il layer di punti selezionati:", layer_names, 0, False
        ...
        if len(selected_features) < 2:
            ...
            if ok_q and quota_choice:
                ...
                if lunghezza_asse == 0:
                    ...
                    # Ordinamento in base alla progressiva lungo l'asse
                    ...
                    if filepath:
                        ...
                        with open(filepath, "w", encoding="utf-8") as f:
                            ...
                            # Layer e Polilinea Profilo 2D (X = Progressiva Proiettata, Y = Quota)
                            ...
                            # Testi Quote e Progressive sul grafico 2D
                            ...
                            # Traccia 3D Reale con Punti Proiettati sull'asse in Mappa
